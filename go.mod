...
replace github.com/go-viper/mapstructure/v2 v2.2.1 => github.com/go-viper/mapstructure/v2 v2.4.0

replace google.golang.org/grpc v1.72.1 => google.golang.org/grpc v1.79.3
