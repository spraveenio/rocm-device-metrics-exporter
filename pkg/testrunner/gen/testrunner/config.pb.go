...
type TestRunnerConfig struct {
	...
	TestConfig map[string]*TestCategoryConfig `protobuf:"bytes,1,rep,name=TestConfig,json=testConfig,proto3" json:"TestConfig,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type TestCategoryConfig struct {
	...
	TestLocationTrigger map[string]*TestTriggerConfig `protobuf:"bytes,1,rep,name=TestLocationTrigger,json=testLocationTrigger,proto3" json:"TestLocationTrigger,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type TestTriggerConfig struct {
	...
	TestParameters map[string]*TestParameters `protobuf:"bytes,1,rep,name=TestParameters,json=testParameters,proto3" json:"TestParameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type TestParameters struct {
	...
	TestCases        []*TestParameter        `protobuf:"bytes,1,rep,name=TestCases,json=testCases,proto3" json:"TestCases,omitempty"`
	LogsExportConfig []*TestLogsExportConfig `protobuf:"bytes,2,rep,name=LogsExportConfig,json=logsExportConfig,proto3" json:"LogsExportConfig,omitempty"`
}
...
type TestParameter struct {
	...
	Recipe         string   `protobuf:"bytes,1,opt,name=Recipe,json=recipe,proto3" json:"Recipe,omitempty"`
	TimeoutSeconds uint32   `protobuf:"varint,2,opt,name=TimeoutSeconds,json=timeoutSeconds,proto3" json:"TimeoutSeconds,omitempty"`
	Iterations     uint32   `protobuf:"varint,3,opt,name=Iterations,json=iterations,proto3" json:"Iterations,omitempty"`
	StopOnFailure  bool     `protobuf:"varint,4,opt,name=StopOnFailure,json=stopOnFailure,proto3" json:"StopOnFailure,omitempty"`
	DeviceIDs      []string `protobuf:"bytes,5,rep,name=DeviceIDs,json=deviceIDs,proto3" json:"DeviceIDs,omitempty"`
}
...
type TestLogsExportConfig struct {
	...
	Provider   TestLogsExportConfig_CloudProvider `protobuf:"varint,1,opt,name=Provider,json=provider,proto3,enum=testrunner.TestLogsExportConfig_CloudProvider" json:"Provider,omitempty"`
	BucketName string                             `protobuf:"bytes,2,opt,name=BucketName,json=bucketName,proto3" json:"BucketName,omitempty"`
	SecretName string                             `protobuf:"bytes,3,opt,name=SecretName,json=secretName,proto3" json:"SecretName,omitempty"`
}
...
type TestRunnerStatus struct {
	...
	TestStatus map[string]string `protobuf:"bytes,1,rep,name=TestStatus,json=testStatus,proto3" json:"TestStatus,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_config_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x0a, 0x74, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x5d, 0x0a,
	...
	0x67, 0x67, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x13, 0x74, 0x65, 0x73, 0x74, 0x4c,
	...
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0e, 0x74, 0x65, 0x73, 0x74, 0x50, 0x61, 0x72, 0x61,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x09, 0x74, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65,
	...
	0x73, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x10, 0x6c,
	0x6f, 0x67, 0x73, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22,
	0xb3, 0x01, 0x0a, 0x0d, 0x54, 0x65, 0x73, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x69, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x72, 0x65, 0x63, 0x69, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x54, 0x69, 0x6d,
	...
	,
