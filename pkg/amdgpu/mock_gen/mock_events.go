...
// Source: /import/src/github.com/pensando/device-metrics-exporter/pkg/amdgpu//gen/amdgpu/events_grpc.pb.go
...
func (mr *MockEventSvcClientMockRecorder) EventGet(ctx, in interface{}, opts ...interface{}) *gomock.Call {
...
// EventGet indicates an expected call of EventGet.
func (mr *MockEventSvcServerMockRecorder) EventGet(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDebugEventSvcClientMockRecorder) EventGen(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
...
// EventGen indicates an expected call of EventGen.
func (mr *MockDebugEventSvcServerMockRecorder) EventGen(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
