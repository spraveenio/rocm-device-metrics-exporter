...
//
//	mockgen --destination=/import/src/github.com/pensando/device-metrics-exporter/pkg/amdgpu/mock_gen/mock_events.go -package=mock_gen --source=/import/src/github.com/pensando/device-metrics-exporter/pkg/amdgpu//gen/amdgpu/events_grpc.pb.go
//
