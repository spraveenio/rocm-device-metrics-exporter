...
| &cross;    | &cross;   | GPU_MMA_ACTIVITY                                             | Average multimedia engine usages in percentage (0 - 100)  [*Depricated from 6.14.14 driver*]                                                   |
| &cross;    | &cross;   | GPU_VCN_ACTIVITY                                             | List of VCN encode/decode engine utilization per AID    [*Depricated from 6.14.14 driver*]                                                     |
| &cross;    | &cross;   | GPU_JPEG_ACTIVITY                                            | List of JPEG engine activity in percentage (0 - 100) [*Depricated from 6.14.14 driver*]                                                        |
...
| &check;    | &check;   | PCIE_NACK_RECEIVED_COUNT                                     | PCIe NACK received accumulated count                                                                                                           |
...
| &cross;    | &check;   | GPU_ECC_UNCORRECT_SMN                                        | Uncorrectable ECC error in SMN                                                                                                                 |
...
| &cross;    | &check;   | GPU_XGMI_LINK_TX                                             | Accumulated XGMI Link Data Write in KB**                                                                                                       |
...
| &cross;    | &check;   | GPU_MIN_CLOCK                                                | Minimum Clock measure of the GPU in   Mhz                                                                                                      |
| &cross;    | &check;   | GPU_MAX_CLOCK                                                | Maximum Clock measure of the GPU in   Mhz                                                                                                      |
| &cross;    | &check;   | GPU_VIOLATION_PROCESSOR_HOT_RESIDENCY_PERCENTAGE             | Process Hot Residency Percentage Violation Counter                                                                                             |
| &cross;    | &check;   | GPU_VIOLATION_PPT_RESIDENCY_PERCENTAGE                       | Package Power Tracking Percentage Violation Counter                                                                                            |
| &cross;    | &check;   | GPU_VIOLATION_SOCKET_THERMAL_RESIDENCY_PERCENTAGE            | Socket Thermal Percentage Violation Counter                                                                                                    |
| &cross;    | &check;   | GPU_VIOLATION_VR_THERMAL_RESIDENCY_PERCENTAGE                | Voltage Rail Percentage Violation Counter                                                                                                      |
| &cross;    | &check;   | GPU_VIOLATION_HBM_THERMAL_RESIDENCY_PERCENTAGE               | HBM Percentage Violation Counter                                                                                                               |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_POWER_ACCUMULATED   | GFX Clock Below Host Limit Power Accumulated Violation Counter Per Compute Core                                                                |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_POWER_PERCENTAGE    | GFX Clock Below Host Limit Power Percentage Violation Counter Per Compute Core                                                                 |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_THERMAL_ACCUMULATED | GFX Clock Below Host Limit Power Accumulated Violation Counter Per Compute Core                                                                |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_THERMAL_PERCENTAGE  | GFX Clock Below Host Limit Power Percentage Violation Counter Per Compute Core                                                                 |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_LOW_UTILIZATION_ACCUMULATED          | GFX Clock Low Utilization Accumulated Violation Counter Per Compute Core                                                                       |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_LOW_UTILIZATION_PERCENTAGE           | GFX Clock Low Utilization Percentage Violation Counter Per Compute Core                                                                        |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_TOTAL_ACCUMULATED   | GFX Clock Below Host Limit Total Accumulated Violation Counter Per Compute Core                                                                |
| &cross;    | &check;   | GPU_VIOLATION_GFX_CLOCK_BELOW_HOST_LIMIT_TOTAL_PERCENTAGE    | GFX Clock Below Host Limit Total Percentage Violation Counter Per Compute Core                                                                 |
