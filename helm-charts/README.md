...
![Version: v1.5.3](https://img.shields.io/badge/Version-v1.5.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.5.3](https://img.shields.io/badge/AppVersion-v1.5.3-informational?style=flat-square)
...
| image.tag | string | `"v1.5.3"` | metrics exporter image tag |
